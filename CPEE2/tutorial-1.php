...
<body>
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <h2 class="head">Development Tutorials</h2>
                </div>
            ...
            <?php
            $query = "SELECT * FROM `product` WHERE category = 5";
            $result = mysqli_query($con,$query) or die($query->error);
                        ...
                        <div class="content">
                            <form action="" method="post" >
                                <div class="panel-heading">
                                    <a class="pop"  tabindex="0" data-toggle="popover" data-trigger="hover" title="<?php echo $row['product_name']; ?>" data-content="<?php echo $row['product_desc'];?>">

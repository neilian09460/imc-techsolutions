...
<body>
    ...
    <section>
        ...
        <div class="container">   
            <div class="row">
                <div class="col-md-2">
                    <h4><span class="fa fa-shopping-cart"></span> Cart list</h4>
                </div>
                <div class="col-md-10">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                <th><?php echo $row['cart_time']; ?></th>
                                <th><?php echo $row['product_name'] ?></th>
                                <!-- <th><?php echo $row['qty']; ?></th> -->
                                <th><?php echo $row['price']; ?></th> 
                                <th><a onclick="return confirm('Do you want to delete this data?')" href="delete.php?cart-id=<?php echo $row['cart_id']?>" value="<?php echo $row['cart_id']?>" class="btn btn-danger btn-sm"><i class="fa fa-trash-o" aria-hidden="true"></i></a></th>
                            </tr>
                        </tbody>
                        <?php } ?>  
                    </table>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <form action="receipt.php" method="post">
                        <a onclick="return confirm('Are you checking out? Data in the cart will be deleted.')">
                        <input class="btn btn-success" type="submit" name="checkout" id="checkout" value="Check out"></a> 
                    </form>

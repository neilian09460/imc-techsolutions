                    ...
                    <div class="row">
                        <div class="col-xs-12 text-right">
                            <div class="social">
                                ...
                                if ($_SESSION['type'] == 1) { 
                                    echo"
                                <a href=\"admin-dashboard.php\" style=\"padding-right: 700px;\"><i class=\"fa fa-database\"></i><span class=\"hidden-xs text-uppercase\">Go to dashboard</span></a> ";
                                } ?>
        ...
        <div id="content">
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading">
                                <h2>Who's behind this company?</h2>
                            </div>

                            <p class="lead">
                                We guarantee good ECOMMERCE, good PRODUCTS and good SERVICES so that every of our customer will come back to us again and again. 
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="team-member" data-animate="fadeInUp">
                                <div class="image">
                                        <img src="img/member/Arvin.png" alt="" class="img-responsive img-circle">
                                </div>
                                <h3>Arvin Oliva</h3>
                                <h4>CEO</h4>
                                <div class="social1">
                            ...
                            <!-- /.team-member --><hr style="border: solid;">
                        </div>
                        <div class="col-md-1"></div>
                        <div class="col-md-3" data-animate="fadeInUp">
                            <div class="team-member">
                                <div class="image">
                                        <img src="img/member/Ceddy.jpg" alt="" class="img-responsive img-circle">
                                </div>
                                <h3>Cedric Jariel</h3>
                        ...
                        <div class="col-md-3" data-animate="fadeInUp">
                            <div class="team-member">
                                <div class="image">
                                        <img src="img/member/Neil.png" alt="" class="img-responsive img-circle">
                                </div>
                                <h3>Neil Ian Palima</h3>
                                <h4>Accountant</h4>
                                <div class="social1">
                                    <a href="#" class="external facebook" data-animate-hover="pulse"><i class="fa fa-facebook"></i></a>
                                    <a href="#" class="external gplus" data-animate-hover="pulse"><i class="fa fa-google-plus"></i></a>
                    ...
                    <div class="row">
                        <div class="col-md-3" data-animate="fadeInDown">
                            <div class="team-member">
                                <div class="image">
                                        <img src="img/member/Cln.jpg" alt="" class="img-responsive img-circle">
                                </div>
                                <h3>Ma. Celine Penaredondo</h3>
                                <h4>eCommerce Marketing Specialist</h4>
                                <div class="social1">
                                    <a href="#" class="external facebook" data-animate-hover="pulse"><i class="fa fa-facebook"></i></a>
                                    <a href="#" class="external gplus" data-animate-hover="pulse"><i class="fa fa-google-plus"></i></a>
                                    <a href="#" class="external twitter" data-animate-hover="pulse"><i class="fa fa-twitter"></i></a>
                        ...
                        <div class="col-md-3" data-animate="fadeInDown">
                            <div class="team-member">
                                <div class="image">
                                        <img src="img/member/law.jpg" alt="" class="img-responsive img-circle">
                                </div>
                                <h3>Mark Lawrence Zaballero</h3>
                        ...
                        <div class="col-md-3" data-animate="fadeInDown">
                            <div class="team-member">
                                <div class="image">
                                        <img src="img/member/mii.jpg" alt="" class="img-responsive img-circle">
                                </div>
                                <h3>Meldy Pontiveros</h3>
